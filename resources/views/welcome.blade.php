...
<div class="row my-5">
  <div class="col-md-8 offset-md-2">
    <div class="row text-center">
      <div class="col-md-4">
        <img src="{{asset('img/gwen_pic.jpg')}}" class="rounded-circle mx-auto d-block" style="width:200px">
        <br/>
        <b>Gwen Merida</b>
        <br/>
        Software Developer
      ...
      <div class="col-md-4">
        <img src="{{asset('img/jp_pic.jpg')}}" class="rounded-circle mx-auto d-block" style="width:200px">
        <br/>
        <b>JP Salvacion</b>
        <br/>
      ...
      <div class="col-md-4">
        <img src="{{asset('img/mica_pic.jpg')}}" class="rounded-circle mx-auto d-block" style="width:200px">
        <br/>
        <b>Mica Delmonte</b>
        <br/>
        Frontend Developer
